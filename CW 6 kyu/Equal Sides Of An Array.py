...
# position of the array, the sum of left side of the index ({1,2,3}) and the sum of the right side of the index ({3,
# 2,1}) both equal 6.
#
# Let's look at another one. You are given the array {1,100,50,-51,1,1}: Your function will return the index 1,
# because at the 1st position of the array, the sum of left side of the index ({1}) and the sum of the right side of
...
#
# Output: The lowest index N where the side to the left of N is equal to the side to the right of N. If you do not
